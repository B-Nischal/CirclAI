...
git clone https://github.com/B-Nischal/circlAI.git

cd circlAI/circl

Update application.yml:

aws: accessKey: YOUR_ACCESS_KEY secretKey: YOUR_SECRET_KEY region: YOUR_REGION bucketName: YOUR_BUCKET_NAME
